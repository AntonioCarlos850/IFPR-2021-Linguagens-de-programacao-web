<?php
    require_once __DIR__."/atividade3.php";

    $gerador = new geradorFakeNews();

    $frase = "";
    if(isset($_POST["nome"]) && isset($_POST["nome"][0]) && isset($_POST["mes_de_nascimento"])
        && $_POST["mes_de_nascimento"] > 0 && $_POST["mes_de_nascimento"] < 13  
        && isset($_POST["dia_de_nascimento"]) && $_POST["dia_de_nascimento"] > 0 && $_POST["dia_de_nascimento"] < 32)
    {
        $frase = $gerador->gerar_frase($_POST["nome"], $_POST["mes_de_nascimento"], $_POST["dia_de_nascimento"]);
    }
?>
<!DOCTYPE html>
<html lang="en">
